...
const data = {
  ...
  authority: 'ISACA',
  authorityUrl: 'https://cmmiinstitute.com',
  year: '2002',
  description: 'To improve organizational performance and process maturity across software engineering and system development.',

  whatIs: 'CMMI v2.0 (managed by ISACA since 2016) is a process improvement framework that evaluates organizational capability across five maturity levels — Level 1 (Initial), Level 2 (Managed), Level 3 (Defined), Level 4 (Quantitatively Managed), and Level 5 (Optimizing). It consolidates the formerly separate CMMI-DEV, CMMI-SVC, and CMMI-ACQ models into one unified framework organized across 25 Practice Areas, covering software development, service delivery, and supply chain management within a single appraisal system.',
  roleImportance: 'It provides a framework for evaluating and improving the maturity of an organization\'s processes, moving from ad-hoc activities to optimized, measurable processes.',
